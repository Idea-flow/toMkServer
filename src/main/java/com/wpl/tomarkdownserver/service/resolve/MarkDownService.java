...
import com.wpl.tomarkdownserver.config.AppBean;
import com.wpl.tomarkdownserver.config.ThreadPoolConfig;
        ...
        for (Element element : elements) {
            threadPool.execute(() -> {
                ...
                try {
                    ...
                    pic.setPNAME(id);
                    pic.setPATH(path);
                    PicMapper picMapper = AppBean.getBean(PicMapper.class);
